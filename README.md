...
Este repositorio hace uso del reositorio app-task-plannerForntEnd una rama (Lab-2.2-security) para hacer los cambios necesarios para la autenticación del usuario haciendo uso de tokens.

### Ejecutar
1. Clone el repositorio app-task-planner-frontEnd (rama: lab-2.2-security):
    https://github.com/acai-bjca/app-task-planner-frontEnd/tree/lab-2.2-security
2. Clone este repositorio (spring-boot-scecure-app):
    https://github.com/acai-bjca/spring-boot-secure-app
3. Construya y ejecute spring-boot-scecure-app:
    gradle build
    gradle bootRun
4. Ejecute el app-task-planner-frontEnd
    npm install
    npm start
5. Para verificar el funcionamiento:
    ingrese con los siguientes datos
    correo: test@mail.com
    contraseña: password

    Como el usuario está registrado en spring-boot-scecure-app (backend) acepta la autenticación. Si lo intenta con un usuario diferente,no pordrá ingresar a la aplicación.

    Para este laboratorio no está disponible la funcionalidad para crear una nueva cuenta.
